...
public class utilPractice {
		...
		if ((negocio.Empleados.existeXcontraseña(contra)==true)&&(lugar>=0))
		{
			...
			while(cont.equals("s")||cont.equals("S"))
			{
					...
					if(negocio.Empleados.list.get(lugar).getClass()== Gerente.class)
					{
						...
						if (negocio.ProductosToProveedor.existe(id)==true)
						{
							...
							if(negocio.ProductosToProveedor.list.get(lugar3).getCantidad()>=cant)
							{
								...
								negocio.getListComp().add(recibo);
				...
				System.out.println(principalMenu);
					break;
				case(5):
					System.out.println("Vemos todas las transacciones");
				negocio.Mostrarcompro();
				//negocio.listarTodo();
	...
	public void registroEmpleado()
	{
		...
		while(cont.equals("s")||cont.equals("S"))
		{
			...
			case 2:
				...
				System.out.println("Ingrese el sexo");
				Sexo=scanner.next();
				Vendedor vendedor=new Vendedor(nombre,apellido,domicilio,Cuil,Sexo,Dni,contraseña);		
				System.out.println(principalMenu);
			...
			case(3):
				...
				Sexo=scanner.next();
				*/
				//Gerente gerente =new Gerente(nombre,apellido,domicilio,Cuil,Sexo,Dni,contraseña);
				Gerente gerente2 =new Gerente("nico","rooldan","asdas",123,"m",123,"nico1");
				negocio.Empleados.add(gerente2);
				System.out.println(principalMenu);
	...
	public void ingresoProveedor()
	{
		...
		if((negocio.Proveedores.existeXcontraseña(contra)==true)&&(lugar>=0))
		{
			...
			Pantalon Panta=new Pantalon(2, "Rojo", 200, "Vans", 30," 0", 20);
			Pantalon Panta1=new Pantalon(12, "verde", 200, "Nike", 25,"0", 0123);
			Pantalon Panta2=new Pantalon(5, "Amarillo", 200, "DC", 123," 0",123 );
			//negocio.ProductosToProveedor.add(Panta);
			negocio.ProductosToProveedor.list.add(Panta);
			negocio.ProductosToProveedor.list.add(Panta1);
			negocio.ProductosToProveedor.list.add(Panta2);
			//negocio.ProductosToProveedor.add(Panta1);
			//negocio.ProductosToProveedor.add(Panta2);
			Remera remera3=new Remera(3,"azul",500,"nike",25,"0",14);
			Remera remera1=new Remera(3,"negro",500,"adidas",25,"0",14);
			Remera remera2=new Remera(3,"gris",500,"dc",25,"0",14);
			negocio.ProductosToProveedor.list.add(remera3);
			negocio.ProductosToProveedor.list.add(remera1);
			negocio.ProductosToProveedor.list.add(remera2);
			//negocio.ProductosToProveedor.add(remera);
			//negocio.ProductosToProveedor.add(remera1);
			//negocio.ProductosToProveedor.add(remera2);
			Buzo buzo3=new Buzo(1.2f,"marron",800.f,"descripcion",4,"0",0);
			Buzo buzo1=new Buzo(1.2f,"amarillo",800.f,"descripcion",22,"0",0);
			Buzo buzo2=new Buzo(1.2f,"verde",800.f,"descripcion",12,"0",0);

			negocio.ProductosToProveedor.list.add(buzo3);
			negocio.ProductosToProveedor.list.add(buzo1);
			negocio.ProductosToProveedor.list.add(buzo2);
	...
	public void registroUsuario()
	{
		...
		while(cont.equals("s")||cont.equals("S"))
		{
			...
			Cliente cliente=new Cliente(nombre,apellido,domicilio,Cuil,Sexo,Dni,contraseña);
			...
			*/
				...
				Proveedor proveedor=new Proveedor("nico","rooldan","asdas",123,"m",123,"nico3");
			  //Proveedor proveedor=new Proveedor(nombre,apellido,domicilio,Cuil,Sexo,Dni,contraseña);
